...
module.hot.dispose(reloadCSS);
module.hot.accept(reloadCSS);
},{"_css_loader":"node_modules/parcel-bundler/src/builtins/css-loader.js"}],"src/styles/Field.sass":[function(require,module,exports) {
var reloadCSS = require('_css_loader');

module.hot.dispose(reloadCSS);
module.hot.accept(reloadCSS);
},{"_css_loader":"node_modules/parcel-bundler/src/builtins/css-loader.js"}],"src/styles/Card.sass":[function(require,module,exports) {
var reloadCSS = require('_css_loader');

module.hot.dispose(reloadCSS);
module.hot.accept(reloadCSS);
},{"_css_loader":"node_modules/parcel-bundler/src/builtins/css-loader.js"}],"src/img/card.png":[function(require,module,exports) {
module.exports = "/card.ce633bda.png";
},{}],"src/components/Card.jsx":[function(require,module,exports) {
"use strict";
...
function Card(props) {
  return (// <div className='card' onClick={(e) => props.onClick(e)} id={props.name}>{props.name}</div>
...
},{"react":"node_modules/react/index.js","../styles/Card.sass":"src/styles/Card.sass","../img/card.png":"src/img/card.png"}],"src/styles/Counter.sass":[function(require,module,exports) {
var reloadCSS = require('_css_loader');

module.hot.dispose(reloadCSS);
module.hot.accept(reloadCSS);
},{"_css_loader":"node_modules/parcel-bundler/src/builtins/css-loader.js"}],"src/components/Counter.jsx":[function(require,module,exports) {
"use strict";
...
exports.default = _default;
},{"react":"node_modules/react/index.js","../styles/Counter.sass":"src/styles/Counter.sass"}],"src/img/s_artuhov.jpeg":[function(require,module,exports) {
module.exports = "/s_artuhov.2ecfe374.jpeg";
},{}],"src/img/s_azarov.jpeg":[function(require,module,exports) {
module.exports = "/s_azarov.c80fd96d.jpeg";
},{}],"src/img/s_burkov.jpeg":[function(require,module,exports) {
module.exports = "/s_burkov.af2527ad.jpeg";
},{}],"src/img/s_civilev.jpeg":[function(require,module,exports) {
module.exports = "/s_civilev.d63312ab.jpeg";
},{}],"src/img/s_moor.jpeg":[function(require,module,exports) {
module.exports = "/s_moor.03f0711d.jpeg";
},{}],"src/img/s_nikitin.jpeg":[function(require,module,exports) {
module.exports = "/s_nikitin.1caa7776.jpeg";
},{}],"src/img/s_nikolaev.jpeg":[function(require,module,exports) {
module.exports = "/s_nikolaev.3bc7729d.jpeg";
},{}],"src/img/s_nosov.jpeg":[function(require,module,exports) {
module.exports = "/s_nosov.a410aab3.jpeg";
},{}],"src/containers/Field.jsx":[function(require,module,exports) {
"use strict";
...
require("../styles/Field.sass");

var _Card = _interopRequireDefault(require("../components/Card"));

var _Counter = _interopRequireDefault(require("../components/Counter"));

var _s_artuhov = _interopRequireDefault(require("../img/s_artuhov.jpeg"));

var _s_azarov = _interopRequireDefault(require("../img/s_azarov.jpeg"));

var _s_burkov = _interopRequireDefault(require("../img/s_burkov.jpeg"));

var _s_civilev = _interopRequireDefault(require("../img/s_civilev.jpeg"));

var _s_moor = _interopRequireDefault(require("../img/s_moor.jpeg"));

var _s_nikitin = _interopRequireDefault(require("../img/s_nikitin.jpeg"));

var _s_nikolaev = _interopRequireDefault(require("../img/s_nikolaev.jpeg"));

var _s_nosov = _interopRequireDefault(require("../img/s_nosov.jpeg"));
...
function (_Component) {
  ...
  function Field(props) {
    ...
    _this.state = {
      cardSymbols: [{
        src: _s_artuhov.default,
        id: 0
      }, {
        src: _s_azarov.default,
        id: 1
      }, {
        src: _s_burkov.default,
        id: 2
      }, {
        src: _s_civilev.default,
        id: 3
      }, {
        src: _s_moor.default,
        id: 4
      }, {
        src: _s_nikitin.default,
        id: 5
      }, {
        src: _s_nikolaev.default,
        id: 6
      }, {
        src: _s_nosov.default,
        id: 7
      }],
      moves: 0,
      displayMoves: 0,
  ...
  _createClass(Field, [{
    ...
    value: function clickHandler(e) {
      ...
      var success;
      var isAllowUpdate = this.checkForUpdateMoves(card);
    ...
    key: "updateMoves",
    value: function updateMoves(moves) {
      var displayMoves = this.state.displayMoves;
      this.setState({
        moves: ++moves
      });
    ...
    key: "checkForUpdateMoves",
    value: function checkForUpdateMoves(card) {
      var prevCard = this.state.prevCard;
      return !prevCard || prevCard.id !== card.id ? true : false;
    }
  }, {
    key: "checkCouple",
    value: function checkCouple(card) {
      var prevActiveCard = this.state.prevCard;
      return prevActiveCard && prevActiveCard.id[0] === card.id[0] ? true : false;
    }
  }, {
    key: "hideCards",
    value: function hideCards(card) {
      var prevActiveCard = this.state.prevCard;
      var hideCard = this.styles.hideCard;
    ...
    key: "findedCards",
    value: function findedCards() {
      var findedCards = this.state.findedCards;
      findedCards += 1;
      this.setState({
    ...
    key: "showPopup",
    value: function showPopup(moves) {
      this.props.showResult(moves);
    }
  }, {
    key: "setActiveCard",
    value: function setActiveCard(card) {
      var prevActiveCard = this.state.prevCard;
      var activeCard = this.styles.activeCard;
    ...
    key: "prepareCard",
    value: function prepareCard(card, num) {
      var key = card.id + '' + num;
    ...
    value: function componentDidMount() {
      ...
      var cardsListFirstPart = this.state.cardSymbols.map(function (card) {
        return _this2.prepareCard(card, 0);
      });
      var cardsListSecondPart = this.state.cardSymbols.map(function (card) {
        return _this2.prepareCard(card, 1);
      });

      var cardsList = _toConsumableArray(cardsListFirstPart).concat(_toConsumableArray(cardsListSecondPart)).sort(this.randomazeArr);
...
var _default = Field;
exports.default = _default;
},{"react":"node_modules/react/index.js","../styles/Field.sass":"src/styles/Field.sass","../components/Card":"src/components/Card.jsx","../components/Counter":"src/components/Counter.jsx","../img/s_artuhov.jpeg":"src/img/s_artuhov.jpeg","../img/s_azarov.jpeg":"src/img/s_azarov.jpeg","../img/s_burkov.jpeg":"src/img/s_burkov.jpeg","../img/s_civilev.jpeg":"src/img/s_civilev.jpeg","../img/s_moor.jpeg":"src/img/s_moor.jpeg","../img/s_nikitin.jpeg":"src/img/s_nikitin.jpeg","../img/s_nikolaev.jpeg":"src/img/s_nikolaev.jpeg","../img/s_nosov.jpeg":"src/img/s_nosov.jpeg"}],"src/img/popup_back.png":[function(require,module,exports) {
module.exports = "/popup_back.76970129.png";
},{}],"src/styles/Popup.sass":[function(require,module,exports) {
var reloadCSS = require('_css_loader');

module.hot.dispose(reloadCSS);
module.hot.accept(reloadCSS);
},{"_css_loader":"node_modules/parcel-bundler/src/builtins/css-loader.js"}],"src/components/Popup.jsx":[function(require,module,exports) {
"use strict";
...
var _popup_back = _interopRequireDefault(require("../img/popup_back.png"));
...
function Popup(props) {
  var divStyle = {
    backgroundImage: 'url(' + _popup_back.default + ')'
  };
  return _react.default.createElement("div", {
    style: divStyle,
    className: props.result ? 'popup popup__show' : 'popup'
  }, _react.default.createElement("div", {
    className: "popup__inner"
  }, _react.default.createElement("p", {
    className: "popup__descr"
  }, "\u041D\u0430\u0439\u0442\u0438 \u0434\u0432\u0443\u0445 \u043E\u0434\u0438\u043D\u0430\u043A\u043E\u0432\u044B\u0445 \u0433\u0443\u0431\u0435\u0440\u043D\u0430\u0442\u043E\u0440\u043E\u0432: \u0438\u0433\u0440\u0430 \"\u041C\u0435\u0434\u0443\u0437\u044B\""), _react.default.createElement("div", {
    className: "popup__result"
  }, _react.default.createElement("p", {
    className: "popup__result-text"
  }, "\u042F \u043C\u043E\u0433\u0443 \u0440\u0430\u0437\u043B\u0438\u0447\u0438\u0442\u044C \u0433\u0443\u0431\u0435\u0440\u043D\u0430\u0442\u043E\u0440\u043E\u0432 \u0441 ", props.result, " \u0440\u0430\u0437"))));
}

var _default = Popup;
exports.default = _default;
},{"react":"node_modules/react/index.js","../img/popup_back.png":"src/img/popup_back.png","../styles/Popup.sass":"src/styles/Popup.sass"}],"src/App.jsx":[function(require,module,exports) {
"use strict";
...
var _Field = _interopRequireDefault(require("./containers/Field"));
...
function (_Component) {
  ...
  _createClass(App, [{
    key: "showResult",
    value: function showResult(moves) {
      var result = moves;
      this.setState({
        result: result
      });
...
var _default = App;
exports.default = _default;
},{"react":"node_modules/react/index.js","./App.css":"src/App.css","./containers/Field":"src/containers/Field.jsx","./components/Popup":"src/components/Popup.jsx"}],"src/index.js":[function(require,module,exports) {
"use strict";
...
},{"react":"node_modules/react/index.js","react-dom":"node_modules/react-dom/index.js","./index.css":"src/index.css","./App":"src/App.jsx"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
